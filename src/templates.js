export const templates = [
    {
        ...
        _v: 2,
        fields: [
            { id: 'preheader', label: 'Preheader (ukryty tekst)', type: 'text', default: 'Najnowsze informacje z naszego biura prasowego' },
            ...
            { id: 'heroImage', label: 'URL Obrazka (Hero)', type: 'image-url', default: 'https://images.unsplash.com/photo-1555421689-491a97ff2040?auto=format&fit=crop&w=600&h=300&q=80', visibleIf: 'showHeroImage' },
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; color: #333333;">
    ...
    },
    {
        ...
        fields: [
            ...
            { id: 'content', label: 'Treść (akapity)', type: 'textarea', default: 'Firma ogłasza dzisiaj...\n\nDrugi akapit tekstu.' },
